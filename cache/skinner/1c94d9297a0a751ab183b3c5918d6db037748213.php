...
function haanga_1c94d9297a0a751ab183b3c5918d6db037748213($vars15047f98d0cd60, $return=FALSE, $blocks=array())
{
    extract($vars15047f98d0cd60);
    if ($return == TRUE) {
        ob_start();
    }
    echo '<!DOCTYPE html>
